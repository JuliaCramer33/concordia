...
(function () {
  ...
  function Edit(props) {
    ...
    function scrollByDir(dir) {
      ...
      var candidates = [items, layout, layout && layout.parentElement].filter(Boolean);
      var container = candidates.find(function (elmt) {
        return (elmt.scrollWidth - elmt.clientWidth) > 1;
      }) || items;

      var slides = layout ? Array.prototype.slice.call(layout.children) : Array.prototype.slice.call(items.children);
        ...
        el(
          ...
          el(
            ...
            el(
              InnerBlocks,
              {
                // Allow any block inside the carousel slides
  ...
  registerBlockType('kanahoma/carousel', {
    edit: Edit,
